package cloud.spec.api.persistence.mongo

import java.util.UUID

import cloud.spec.api.configuration.Configured
import cloud.spec.api.domain.models._
import cloud.spec.api.persistence._
import cloud.spec.api.persistence.mongo.Imports._
